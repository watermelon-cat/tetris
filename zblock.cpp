...
zblock::zblock(int xpos, int ypos) {
	x = xpos;
	y = ypos;
	landed = false;
	spin = 1;
}
int zblock::turn(char dir) {
	if (spin == -1) {
		spin *= -1;
		return 1;
	}
...
void zblock::draw(int map[10][16]) {
	if (spin == 1) {
		map[x / 50][y / 50] = 5;
		map[x / 50][(y + 50) / 50] = 5;
		map[(x - 50) / 50][y / 50] = 5;
		map[(x + 50) / 50][(y + 50) / 50] = 5;
	}
	else if (spin == -1) {
		map[x / 50][y / 50] = 5;
		map[(x - 50) / 50][y / 50] = 5;
...
void zblock::land(int map[10][16]) {
	landed = true;
	if (spin == 1) {
		map[x / 50][y / 50] = 50;
		map[x / 50][(y + 50) / 50] = 50;
		map[(x - 50) / 50][y / 50] = 50;
		map[(x + 50) / 50][(y + 50) / 50] = 50;
	}
	else if (spin == -1) {
		map[x / 50][y / 50] = 50;
		map[(x - 50) / 50][y / 50] = 50;
...
void zblock::MoveSideways(char dir, int grid[10][16]) {
	if (spin == 1) {
		if ((dir == 'r') && (x < 500 - 100) &&
...
bool zblock::checkCollision(int grid[10][16]) {
	if (spin == 1) {
